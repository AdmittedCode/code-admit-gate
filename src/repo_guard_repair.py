#!/usr/bin/env python3
"""
Repo Guard — Repair Planner

Generates approval-gated repair plans from Repo Guard validation reports.
...
class ArchitectureRepair:
    ...
    def save_plan(self, path: str) -> None:
        ...
        output.write_text(json.dumps({
            "schema": "repo_guard.repair_plan.v1",
            "created_at": now_iso(),
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Repo Guard — repair planner")
