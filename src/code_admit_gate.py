#!/usr/bin/env python3
"""
Code Admit Gate — Architecture Validator

Manifest-driven structural validation for repositories.

Code Admit Gate is opt-in:
...
class ValidationReport:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            "schema": "code_admit_gate.validation_report.v1",
    ...
    def validate(self) -> ValidationReport:
        ...
        if not self.manifest_path:
            self.report.add(Violation(
                ...
                suggestion="Create code-admit-gate.json to activate validation.",
            ))
            return self.report
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Code Admit Gate — manifest-driven architecture validator")
    ...
    parser.add_argument("--output", default="code-admit-gate-report.json", help="Output report file")
